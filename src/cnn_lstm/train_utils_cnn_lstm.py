...
def save_checkpoint(model, optimizer, epoch, loss, checkpoint_dir, name_model="default"):
    ...
    torch.save({
        ...
        'amp_output_features': model.amp_output_features,
        'phase_output_features': model.phase_output_features,
...
def train_test(dataset_root, normalize, val_split, test_split, batch_size_train, batch_size_val,  num_epochs, learning_rate, amp_output_features, phase_output_features, lstm_hidden_dim, lstm_num_layers, bidirectional):
    ...
    model = CNNLSTMModel(
        amp_output_features=amp_output_features,
        phase_output_features=phase_output_features,
        lstm_hidden_dim=lstm_hidden_dim,
        lstm_num_layers=lstm_num_layers,
