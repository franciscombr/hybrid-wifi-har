...
plot_confusion_matrix(y_test_labels, y_pred,'linearsvm',normalize=True)
...
plot_confusion_matrix(y_test_labels, y_pred_nb,'gaussianNB',normalize=True)
...
plot_confusion_matrix(y_test_labels,y_pred_knn,'knn5',normalize=True)