...
def wandb_train_sweep(config=None):
    with wandb.init(config=config):
        ...
        train_test(dataset_root, normalize, val_split, test_split, batch_size_train, batch_size_val,  num_epochs, learning_rate, hidden_dim, num_layers, bidirectional)
         
def train_test(dataset_root, normalize, val_split, test_split, batch_size_train, batch_size_val,  num_epochs, learning_rate, hidden_dim, num_layers, bidirectional):
