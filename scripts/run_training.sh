...
python3 ../src/csi2har/train_utils_arch01.py --normalize --learning_rate 0.0001 --num_epochs 50 --test_split 0.2 --val_split 0.2  --batch_size_train 16 --batch_size_val 8 --embedding_dim 256 --num_encoder_layers 4 --dataset_root /nas-ctm01/datasets/public/CSI-HAR/Dataset/UT_HAR_CAL_PHASE 
