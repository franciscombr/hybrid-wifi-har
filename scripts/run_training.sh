...
python3 train_model.py --num_epochs 50 --test_split 0.2 --val_split 0.2  --batch_size_train 24 --batch_size_val 8 --embedding_dim 128 --dataset_root /nas-ctm01/datasets/public/CSI-HAR/Dataset/UT_HAR_OG 
