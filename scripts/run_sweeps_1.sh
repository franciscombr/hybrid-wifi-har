...
#SBATCH --job-name=sweep_1    # Job name
#SBATCH -o logs/sweep_1.out       # File containing STDOUT output
#SBATCH -e logs/sweep_1.err       # File containing STDERR output. If ommited, use STDOUT.
