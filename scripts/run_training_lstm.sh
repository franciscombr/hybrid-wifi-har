...
python3 ../src/lstm/train_utils_lstm.py --normalize --learning_rate 0.0001 --num_epochs 50 --test_split 0.2 --val_split 0.2  --batch_size_train 24 --batch_size_val 8 --dataset_root /nas-ctm01/datasets/public/CSI-HAR/Dataset/UT_HAR_CAL_PHASE 
